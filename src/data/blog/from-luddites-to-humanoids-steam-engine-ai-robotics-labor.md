---
title: "From Luddites to Humanoids: What the Steam-Engine Era Tells Us About AI Robotics Replacing Human Labor"
author: Dendi Suhubdy
pubDatetime: 2026-04-28T08:00:00Z
featured: false
draft: false
tags:
  - economics
  ...
  - autor
  - polanyi-paradox
description: "The Luddites were not anti-technology. They were protesting a bundle of wage collapse, skill devaluation, and lost autonomy that mechanization triggered but did not constitute. Reading the modern economics literature — Acemoglu & Restrepo, Allen on the Engels' Pause, Caprettini & Voth on Captain Swing, Autor on polarization, Brynjolfsson on the productivity J-curve — the question for the age of perception-aware and lingual robotics is not whether the reinstatement effect will eventually arrive. It is whether the adjustment window has been compressed past the point where the historical safety valves can open in time."
---
...
I'll walk through what the protesters were actually protesting, why real wages stagnated for half a century while output exploded, what the modern task-based models of automation say about reinstatement of labor, and where perception-aware and language-capable robotics breaks the historical analogy. I'll cite the work where I'm leaning on someone else's data — including [Caprettini & Voth (2020) in *AER: Insights*](https://www.aeaweb.org/articles?id=10.1257/aeri.20190385), [Allen (2009) in *Explorations in Economic History*](https://www.nuff.ox.ac.uk/Users/Allen/engelspause.pdf), [Acemoglu & Restrepo (2019) in *JEP*](https://www.aeaweb.org/articles?id=10.1257/jep.33.2.3), [Acemoglu (2024) NBER WP 32487](https://www.nber.org/papers/w32487), [Autor (2024) NBER WP 32140](https://www.nber.org/papers/w32140), [Brynjolfsson, Li & Raymond (2025) in *QJE*](https://www.nber.org/papers/w31161), [Eloundou et al. (2024) in *Science*](https://www.science.org/doi/10.1126/science.adj0998), [Mokyr, Vickers & Ziebarth (2015) in *JEP*](https://www.aeaweb.org/articles?id=10.1257/jep.29.3.31), and most heavily on [Juhasz, Squicciarini & Voigtländer's 2024 *Annual Review of Economics* essay](https://shapingwork.mit.edu/wp-content/uploads/2024/08/annurev-economics-091823-025129.pdf), which is the cleanest bridge in the literature from the framework-knitters to the BMW Spartanburg humanoid pilots.
...
1. **Wage collapse.** Lancashire cotton spinners' wages fell from 24 shillings/week in 1815 to 18s/week in 1818. Handloom weavers — about 200,000 strong at peak in 1812 — saw piece rates collapse and their numbers grind down to roughly 7,000 by 1861, in what [Leunig and Voth (2018) in *European Review of Economic History*](https://academic.oup.com/ereh/article-abstract/22/4/381/4844095) document as the canonical case of an entire skilled occupation hollowed out by power-loom diffusion.
...
The protest was a bundle protest. Mechanization was the trigger but rarely the constitutive grievance. [Hobsbawm and Rudé's *Captain Swing* (1969)](https://en.wikipedia.org/wiki/Swing_Riots) made this case for the 1830 agricultural unrest, and modern empirical work has tightened it considerably.

The most rigorous quantitative treatment is **[Caprettini and Voth (2020), "Rage Against the Machines: Labor-Saving Technology and Unrest in Industrializing England," *AER: Insights*](https://www.aeaweb.org/articles?id=10.1257/aeri.20190385)**. They study the ~3,000 incidents of the Captain Swing riots, when southern English laborers smashed horse-powered threshing machines that had displaced something like a quarter of agricultural employment in winter. Instrumenting machine adoption by the share of heavy soils (where threshing machines were more profitable), they find threshing-machine intensity roughly *doubles* the probability of riot — from 13% to 26.1% in affected parishes. But the result that matters most for our question is the second one: **areas with industrial outside options had less unrest**. Where displaced agricultural workers could walk to a textile mill or a railway works, they did. Where they could not, they rioted.
...
The pessimist position is **[Allen (2009), "Engels' Pause: Technical Change, Capital Accumulation, and Inequality in the British Industrial Revolution," in *Explorations in Economic History* 46(4)](https://www.nuff.ox.ac.uk/Users/Allen/engelspause.pdf)**. Allen argues real wages were essentially flat from 1790 to 1840, while output per worker rose ~46% and the profit share of national income roughly doubled. He models this as a Lewis-style surplus-labor regime in which capital had to be deepened — that is, accumulated faster than labor — before workers could share in the gains. The mechanism is brutal in its honesty: when the elasticity of labor supply is high (rural-to-urban migration, women and children pulled into the labor force, Irish immigration), profits are reinvested rather than competed away into wages, and the wage bill is anchored to subsistence until the underlying labor surplus is exhausted.

[Feinstein (1998) in *JEH*](https://www.jstor.org/stable/2566618) had earlier constructed the canonical real-wage index showing only ~12% gain across 1780–1840 — a half-century of working-class stagnation in the country that was, by every other measure, becoming the wealthiest in human history.

The optimist counter is **[Clark (2005) in *JPE*](https://www.journals.uchicago.edu/doi/10.1086/498123)**, who argues that with different price weights, real wages rose meaningfully earlier. The most recent reassessment is **[Crafts (2021) in *Oxford Economic Papers*](https://academic.oup.com/oep/article/74/1/1/6145336)**, who synthesizes the debate: yes, the Engels' Pause is real, but it is *smaller and shorter* than Allen claims, and it is largely explained by what Crafts calls "pro-rich growth" — a rising profit share, terms-of-trade shifts, and measurement issues. Most importantly, **[Humphries and Schneider (2019) in *EcHR*](https://onlinelibrary.wiley.com/doi/10.1111/ehr.12693)** add a distributional layer that almost no AI commentator engages with: women and child spinners, who are invisible in the standard male-wage series, were *low-wage throughout the entire period*. Even when male artisan wages held up, the household-level picture was much worse.
...
4. **Education's race against technology.** [Goldin and Katz's *The Race between Education and Technology* (2008)](https://www.hup.harvard.edu/books/9780674035300) frames the 20th-century version of the same argument: as long as the supply of skilled labor grew faster than technology's demand for it, the skill premium fell and labor's share rose. As soon as that race tipped — which they date around 1980 — inequality reasserted itself.
...
- **[Acemoglu & Restrepo (2018), "The Race between Man and Machine," *AER* 108(6)](https://www.aeaweb.org/articles?id=10.1257/aer.20160696)**
- **[Acemoglu & Restrepo (2019), "Automation and New Tasks," *JEP* 33(2)](https://www.aeaweb.org/articles?id=10.1257/jep.33.2.3)**
- **[Acemoglu & Restrepo (2020), "Robots and Jobs: Evidence from US Labor Markets," *JPE* 128(6)](https://www.nber.org/papers/w23285)**

The model decomposes any automation episode into two opposing forces:

- The **displacement effect**: machines take over tasks previously done by labor, mechanically reducing labor's share of output.
- The **reinstatement effect**: technological change creates new tasks where labor has comparative advantage, raising labor's share back up.
...
A complementary line of work is the polarization literature. **[Autor, Levy and Murnane (2003) in *QJE*](https://www.jstor.org/stable/25053940)** introduced the "routine vs. non-routine" task framework, and **[Autor and Dorn (2013) in *AER*](https://www.aeaweb.org/articles?id=10.1257/aer.103.5.1553)** showed that computerization hollows out middle-skill routine jobs while expanding both low-skill services and high-skill professional work — the "polarization" pattern that has dominated rich-country labor markets for thirty years. **[Goos, Manning and Salomons (2014) in *AER*](https://www.aeaweb.org/articles?id=10.1257/aer.104.8.2509)** confirmed this across European economies.

Two forecasting traditions sit on top of this framework. The widely-cited **[Frey and Osborne (2017)](https://www.oxfordmartin.ox.ac.uk/publications/the-future-of-employment)** estimate — "47% of US jobs at high risk of automation" — was occupation-level rather than task-level, used an expert-judgment training set, and contained no productivity or price feedbacks. **[Arntz, Gregory and Zierahn (2016) at the OECD](https://www.oecd-ilibrary.org/social-issues-migration-health/the-risk-of-automation-for-jobs-in-oecd-countries_5jlz9h56dvq7-en)** redid the same exercise at task level and got 9% rather than 47%. The ex-post correlation between Frey-Osborne risk scores and actual job loss is, by [ITIF's 2022 retrospective](https://itif.org/publications/2022/09/30/oops-the-predicted-47-percent-of-job-loss-from-ai-didnt-happen/), about −0.26 — meaning the high-risk occupations grew slightly *more* than the low-risk ones, the opposite of the prediction.
...
- **[Acemoglu (2024), "The Simple Macroeconomics of AI," NBER WP 32487](https://www.nber.org/papers/w32487)** uses Hulten's theorem on task-level exposure and cost savings to bound AI's TFP gains *modestly*: at most 0.66% over ten years, or 0.53% if you adjust for hard-to-learn tasks. He projects that AI widens the capital-labor gap but is, unusually, distributed roughly equally across demographic groups — eroding the standard "skill up to be safe" answer.
- **[Korinek and Trammell (2023), "Economic Growth under Transformative AI," NBER WP 31815](https://www.nber.org/papers/w31815)** sketch scenarios where output expands tenfold while wages collapse, if the share of tasks where humans hold comparative advantage shrinks faster than new tasks emerge.
- **[Autor (2024), "Applying AI to Rebuild Middle Class Jobs," NBER WP 32140](https://www.nber.org/papers/w32140)** is the most genuinely optimistic recent paper. Autor argues that if AI is deployed as expert-judgment *augmentation* for sub-elite workers, it could actually re-fatten the middle class by extending licensed-expertise tasks (medicine, law, code, engineering) to a broader workforce. The empirical anchor is **[Brynjolfsson, Li and Raymond (2025) in *QJE*](https://www.nber.org/papers/w31161)**: a customer-support deployment showed a 14% productivity lift overall, 34% for novices, and almost zero for top performers. Compression toward expert quality.
- **[Eloundou, Manning, Mishkin and Rock (2024) in *Science*](https://www.science.org/doi/10.1126/science.adj0998)** estimate that 80% of US workers have at least 10% of tasks affected by LLMs, and 19% have at least half their tasks affected. Crucially, *higher-income jobs show greater exposure* — an inversion of the skill-biased technical change pattern that defined 1980–2020.
- **[Brynjolfsson, Rock and Syverson (2021), "The Productivity J-Curve," in *AEJ: Macro*](https://www.aeaweb.org/articles?id=10.1257/mac.20180386)** revives Paul David's "dynamo paradox" — electrification took ~30 years to show in factory productivity statistics — and predicts a measured-productivity dip during organizational reorganization, then a steep climb. **The political-unrest window is the dip.**
...
The single best paper bridging all of this back to the historical record is **[Juhasz, Squicciarini and Voigtländer (2024), "Technology, Skills and Geography in the Spatial Diffusion of the Industrial Revolution"](https://shapingwork.mit.edu/wp-content/uploads/2024/08/annurev-economics-091823-025129.pdf)**, with a related MIT *Annual Review of Economics* essay drawing the line directly from the early factory system to humanoid robotics. If you only read one paper from this post, read that one.
...
There is a non-economic layer to this transition that the equations don't capture. Work is not just a wage. It is a primary source of identity, dignity, social belonging, and meaning — a fact the dignity-and-meaning literature ([Sandel's *Tyranny of Merit* (2020)](https://us.macmillan.com/books/9780374289980/thetyrannyofmerit), [Case and Deaton's *Deaths of Despair* (2020)](https://press.princeton.edu/books/hardcover/9780691190785/deaths-of-despair-and-the-future-of-capitalism), [Goldin's *Career and Family* (2021)](https://press.princeton.edu/books/hardcover/9780691201788/career-and-family)) has spent the past decade documenting in detail. The 1810 framework-knitter had a craft identity tied to a generations-long tradition of work. The 2030 knowledge worker has a professional identity that is, for many, the dominant component of selfhood. Replacing the wage with a transfer payment does not replace the identity.
...
| 19th-century lever | What it did | 21st-century analogue |
|---|---|---|
| Factory Acts (1833 onward) + inspectorate | State-funded enforcement of labor standards inside the new technology | AI auditing regimes, red-team requirements, model-card mandates, NIST AI RMF-style frameworks |
| Repeal of Combination Acts (1824) | Legalized collective bargaining inside the new factory regime | Sectoral bargaining for AI-exposed occupations; portable benefits; UBI experiments |
| Reform Acts 1832 / 1867 / 1884 | Created the political constituency for redistribution | Campaign-finance reform; data-rights frameworks; democratic governance of frontier-AI deployment |
| Corn Law repeal (1846) | Lowered cost of subsistence; shifted terms of trade toward labor | Housing supply reform; healthcare cost containment; cost-disease sectors |
| Forster Act (1870) + later 20th-c. high-school movement | Mass schooling that won the race against technology for ~80 years | Continuous reskilling infrastructure; AI-augmented education; the Autor (2024) "expert middle" thesis |
| Trade Union Act (1871) | Recognized unions as legal entities | Algorithmic-management regulation; gig-worker classification; new forms of professional association |
...
- **Magnitude of reinstatement under near-AGI capability.** Acemoglu (2024) bounds it modestly; Korinek-Trammell sketch scenarios where it explodes. The data does not yet discriminate, and anyone telling you confidently which way it goes is selling something.
- **J-curve compression.** The Brynjolfsson-Li-Raymond customer-support results suggest in some occupations the productivity dip may be skipped entirely. In others — physical tasks requiring humanoid-robot capital deepening — the J-curve may stretch closer to the 30-year electrification benchmark.
- **Distributional incidence.** Eloundou et al.'s SBTC inversion is striking. Whether it persists once humanoid robots fully close the embodiment gap is genuinely unknown. The political-economy implications differ wildly depending on whether knowledge workers and service workers are exposed simultaneously or sequentially.
- **Outside-option scaling.** The Caprettini-Voth dampening result is an empirical regularity from 1830, not a theorem. Whether it holds when the technology is general-purpose is the single most important question, because it determines whether the historical safety valve still works.
- **The high-wage-economy reversal.** Allen's argument for *why* Britain mechanized first was that high British wages made labor-saving capital profitable. If the same mechanism operates in 2026, the high-wage knowledge economies — which is to say, exactly the rich-country professional class that thought itself safe — become the prime targets for AI deployment for the same reason.
- **Speed itself as a policy variable.** [Mokyr, Vickers and Ziebarth (2015) in *JEP*](https://www.aeaweb.org/articles?id=10.1257/jep.29.3.31) catalog past technological anxieties — mechanization, automation, computerization — that failed to materialize as predicted. They are right that "this time is different" is a claim that must do work. The work it has to do is showing that the *transition* can be politically and socially absorbed at compressed speed, not that new tasks eventually emerge.
...
- **[Juhasz, Squicciarini & Voigtländer (2024), MIT/*Annual Review of Economics*](https://shapingwork.mit.edu/wp-content/uploads/2024/08/annurev-economics-091823-025129.pdf)** — the cleanest scholarly bridge from the early factory system to humanoid robotics; if you read only one paper from this post, read this one.
- **[Allen (2009), "Engels' Pause," *Explorations in Economic History*](https://www.nuff.ox.ac.uk/Users/Allen/engelspause.pdf)** — the canonical pessimist case on Industrial Revolution wages; sets the frame for thinking about long pauses between productivity and wage growth.
- **[Crafts (2021), "Slow Real Wage Growth during the Industrial Revolution," *Oxford Economic Papers*](https://academic.oup.com/oep/article/74/1/1/6145336)** — the synthesis that resolves the Allen-vs.-Clark pause debate without dismissing either side.
- **[Caprettini & Voth (2020), "Rage Against the Machines," *AER: Insights*](https://www.aeaweb.org/articles?id=10.1257/aeri.20190385)** — the empirical anchor on what predicts unrest, with the all-important "outside options dampen unrest" finding.
- **[Humphries & Schneider (2019), "Spinning the Industrial Revolution," *Economic History Review*](https://onlinelibrary.wiley.com/doi/10.1111/ehr.12693)** — the distributional layer most accounts skip: women and child spinners were low-wage throughout, even when male artisan wages held up.
- **[Acemoglu & Restrepo (2019), "Automation and New Tasks," *JEP*](https://www.aeaweb.org/articles?id=10.1257/jep.33.2.3)** — the cleanest framework paper on displacement vs. reinstatement; required vocabulary for the rest of the field.
- **[Acemoglu (2024), "The Simple Macroeconomics of AI," NBER WP 32487](https://www.nber.org/papers/w32487)** — the modest-bound view on AI productivity gains, with the key insight that AI's distributive effect cuts across demographic groups rather than along skill lines.
- **[Korinek & Trammell (2023), "Economic Growth under Transformative AI," NBER WP 31815](https://www.nber.org/papers/w31815)** — the formalization of the radical-disruption scenarios where output expands tenfold while wages collapse.
- **[Autor (2024), "Applying AI to Rebuild Middle Class Jobs," NBER WP 32140](https://www.nber.org/papers/w32140)** — the most genuinely optimistic recent paper, with a serious mechanism (expert-judgment augmentation) rather than vague techno-optimism.
- **[Brynjolfsson, Li & Raymond (2025), "Generative AI at Work," *QJE*](https://www.nber.org/papers/w31161)** — the empirical anchor for the optimist case; 14% productivity lift overall, 34% for novices, ~0% for top performers.
- **[Eloundou, Manning, Mishkin & Rock (2024), "GPTs are GPTs," *Science*](https://www.science.org/doi/10.1126/science.adj0998)** — the SBTC inversion: higher-income jobs are *more* exposed than past automation waves predicted.
- **[Brynjolfsson, Rock & Syverson (2021), "The Productivity J-Curve," *AEJ: Macro*](https://www.aeaweb.org/articles?id=10.1257/mac.20180386)** — why AI productivity gains may dip before they climb, and why the political-unrest window is precisely the dip.
- **[Mokyr, Vickers & Ziebarth (2015), "The History of Technological Anxiety," *JEP*](https://www.aeaweb.org/articles?id=10.1257/jep.29.3.31)** — the cool historical perspective: many past technological anxieties failed to materialize as predicted, and "this time is different" is a claim that must do work.
- **[Acemoglu & Johnson, *Power and Progress* (2023)](https://shapingwork.mit.edu/power-and-progress/)** — the political-economy frame: distributive outcomes are politically determined, not technologically inevitable; the central thesis informs how to read every other paper on this list.

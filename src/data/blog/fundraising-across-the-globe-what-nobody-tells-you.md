...
tags:
  ...
  - startups
  - emerging-markets
description: "Hard-won lessons from raising capital across continents -- from the geographic bias of investors to the timing of markets, venture debt traps, and why your competitors in emerging markets might be your best exit."
---
...
## The Geographic Bias Is Real and It Is Structural
...
- **Current burn rate** and its trajectory---are you hiring, and if so, how does burn change month over month?
- **Revenue projections** under pessimistic, base, and optimistic scenarios, with honest assumptions about sales cycles and churn.
- **Fundraising timeline distributions**---not "we will close in Q2" but "there is a 30% chance we close in Q2, a 40% chance we close in Q3, and a 30% chance we do not close at all."
- **Market condition sensitivity**---how does a 20% drawdown in public equities affect your fundraising probability and expected valuation? Use historical data. The correlation between public market indices and venture deployment is well-documented.
- **Cash-zero date** under every scenario. This is the number that matters. Not your ARR, not your growth rate, not your TAM. The date on which you run out of money.
...
- **Instrument selection**---when to use a SAFE versus a convertible note versus priced equity, and the downstream consequences of each. A SAFE is not always the right answer, despite what Y Combinator's marketing suggests.
- **Cap table hygiene**---keeping your ownership structure clean, understandable, and attractive to future investors. This means standardized terms where possible, clear vesting schedules, and no hidden gotchas in side letters.
- **Jurisdictional structuring**---where to incorporate, where to hold IP, and how to structure cross-border operations in a way that is tax-efficient without creating regulatory risk. This matters enormously if you are raising across geographies.
- **Protective provisions and governance**---what rights you are giving investors, what rights you are retaining, and how those rights interact as new investors come in at later stages. The board seat you gave your seed investor might block a decision your Series B investor considers essential.
- **Future-round compatibility**---structuring every round so that it does not create obstacles for the next one. The best lawyers are playing chess three moves ahead, thinking about how today's terms will look to a Series B lead who has not entered the picture yet.

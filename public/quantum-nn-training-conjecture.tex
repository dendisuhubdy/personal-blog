...
We state the conjecture in three forms, ordered by increasing strength and decreasing similarity to classical backpropagation.

\begin{conjecture}[Form A: Quantum-accelerated backpropagation]\label{conj:A}
...
\begin{conjecture}[Form B: Backpropagation replacement]\label{conj:B}
...
\begin{conjecture}[Form C: Non-gradient training]\label{conj:C}
